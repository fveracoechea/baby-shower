...
| `rumorHead`                   | Rumor has it only two people know the baby's sex                                | Se rumora que solo dos personas conocen el sexo del bebé                                 |
...
| `st2a` / `st2b` / `st2c`      | that only / TWO PEOPLE / in the whole world know the sex of our baby.           | que solo / DOS PERSONAS / en todo el mundo conocen el sexo de nuestro bebé.              |
...
| `sw2t` / `sw2s`               | WITNESS #2 / The event organizer: opened the envelope and sent coded instructions to both vendors. | TESTIGO N.º 2 / La organizadora del evento: abrió el sobre y envió instrucciones cifradas a ambos proveedores. |
...
| `w2Role` / `w2Desc`           | The event organizer / Opened the envelope and sent separate coded instructions to both vendors. | La organizadora del evento / Abrió el sobre y envió instrucciones cifradas por separado a ambos proveedores. |
